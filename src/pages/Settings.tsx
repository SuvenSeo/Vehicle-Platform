    ...
    <div className="min-h-screen">
      <section className="border-b border-border">
        <div className="mx-auto max-w-[1320px] px-5 py-10 sm:px-6 sm:py-12">
          ...
          <p className="mt-2 text-[15px] leading-relaxed text-muted-foreground">Language, theme, and display preferences.</p>
        </div>
      </section>
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Display labels</p>
              </div>
            </div>
                ...
                return (
                  <button key={o.value} type="button" onClick={() => setLanguage(o.value)} aria-pressed={active}
                    className={cn("flex w-full items-center justify-between rounded-lg border px-3 py-2.5 text-left transition-colors",
                      active ? "border-primary/20 bg-primary/5 text-foreground" : "border-border text-muted-foreground hover:border-border hover:text-foreground"
                    )}
                  >
                    <span>
                    ...
                    <span className={cn("flex h-6 w-6 items-center justify-center rounded-full border", active ? "border-primary/30 bg-primary/15 text-primary" : "border-border text-transparent")}>
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Visual style</p>
              </div>
            </div>
            ...
            <p className="mt-4 rounded-lg border border-border bg-surface px-3 py-2 text-[10px] text-muted-foreground">
