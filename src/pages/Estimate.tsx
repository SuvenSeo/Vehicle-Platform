...
const selectClass = "h-10 rounded-lg border-border bg-surface text-sm text-foreground focus:ring-1 focus:ring-primary/30";
const inputClass = "h-10 rounded-lg border-border bg-surface text-sm text-foreground num focus:ring-1 focus:ring-primary/30";
    ...
    <div className="min-h-screen">
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-[1320px] px-5 py-10 sm:px-6 sm:py-12">
          <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--gold)]/70">Valuation workbench</p>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <div className="rounded-xl border border-border bg-card p-5 sm:p-6">
            <div className="mb-6 flex items-center gap-3 border-b border-border pb-5">
              ...
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">Step 01</p>
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  <label htmlFor="est-make" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Make</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-model" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Model</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-year" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Year</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-cond" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Condition</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-trans" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Transmission</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-fuel" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Fuel type</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-km" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Mileage (km)</label>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="est-dist" className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">District</label>
              ...
              <div className="border-t border-border pt-5">
                <button type="button" onClick={handleEstimate} disabled={!form.make || !form.model || loading}
                  className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[var(--gold)] text-[11px] font-bold uppercase tracking-[0.1em] text-white transition-colors hover:bg-[var(--gold-bright)] disabled:opacity-40 disabled:pointer-events-none"
                >
                  <Gauge className="h-3.5 w-3.5" />
                  {loading ? "Running..." : "Run valuation"}
                </button>
                {!form.make || !form.model ? <p className="mt-2 text-center text-[11px] text-muted-foreground">Select make and model to enable.</p> : null}
                {error && (
          ...
          <div className="rounded-xl border border-border bg-card p-5 sm:p-6 lg:sticky lg:top-20">
            <div className="mb-6 flex items-center justify-between gap-3 border-b border-border pb-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">Step 02</p>
                  <h2 className="text-[14px] font-semibold text-foreground">Market output</h2>
                </div>
              </div>
              {result && (
                <span className="rounded-md border border-primary/15 bg-primary/5 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-primary/80">
                  {result.confidence}
                </span>
              )}
            </div>
            ...
            {result && !loading && (
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-border bg-surface p-4">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Estimated median</p>
                ...
                <div className="flex flex-wrap gap-1.5">
                  <span className="flex items-center gap-1.5 rounded-md border border-primary/15 bg-primary/5 px-2 py-1 text-[10px] font-semibold text-primary/80">
                    <ShieldCheck className="h-3 w-3" /> {result.confidence}
                  </span>
                  <span className="flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-[10px] font-semibold text-muted-foreground">
                ...
                {/* Trajectory */}
                <div className="rounded-lg border border-border bg-surface p-4">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Trajectory</p>
                  {projection ? (
                    <div className="mt-3 space-y-3">
                      <p className="text-[11px] text-muted-foreground">
                        Derived from <span className="num font-semibold text-foreground">{projection.windowMonths}</span> months of data for {form.make} {form.model}.
                      </p>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="rounded-md border border-border bg-surface p-3">
                          <p className="text-[10px] text-muted-foreground">1Y projected</p>
                          <p className="num mt-1 text-[13px] font-bold text-foreground">{formatPrice(projection.oneYearValue)}</p>
                        </div>
                        <div className="rounded-md border border-border bg-surface p-3">
                          <p className="text-[10px] text-muted-foreground">3Y projected</p>
                ...
                {/* Methodology */}
                <div className="rounded-lg border border-border bg-surface p-4">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Methodology</p>
                  <p className="mt-2 text-[11px] leading-relaxed text-muted-foreground">{result.methodology}</p>
                </div>
              </div>
            )}
          </div>
