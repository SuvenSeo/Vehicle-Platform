  ...
  return (
    <div className="page-panel space-y-4 rounded-xl p-6">
      <div className="flex items-center gap-2 mb-2">
         ...
         <span className="rounded-lg border border-primary/20 bg-primary/10 px-2 py-0.5 text-label font-mono font-bold text-primary">Estimate</span>
      </div>
      
      <div className="space-y-3">
        <div className="flex justify-between text-xs text-muted-foreground pb-2 border-b border-white/5">
      ...
      <div className="pt-4 border-t border-white/10 space-y-2">
        <div className="flex items-center justify-between rounded-xl border border-white/5 bg-white/5 p-3">
          <span className="text-xs text-muted-foreground font-medium">Total Est. Taxes</span>
          <span className="text-sm font-bold text-primary num">+{formatPrice(totalTaxEst)}</span>
        </div>
        
        <div className="flex items-center justify-between rounded-xl border border-primary/20 bg-primary/10 p-4">
          <span className="text-xs font-bold uppercase tracking-wider text-primary">Estimated on-road price</span>
