...
export const PULSE_SOURCE_GUIDES: PulseSourceGuide[] = [
  {
    ...
    howWeReadIt: [
      ...
      "Pair registration pace with live listing counts in AutoLens to see whether supply is catching demand.",
    ],
    dealerTip:
  ...
  },
  {
    ...
    howWeReadIt: [
      ...
      "Cross-check tender spikes with segment medians in AutoLens before adjusting floor prices.",
    ],
    dealerTip:
