...
const DICTIONARIES: Record<Language, Dictionary> = {
  en: {
    ...
    "settings.title": "Personalize MilaMark",
    ...
    "chat.tooltip.title": "Ask MilaMark Copilot",
    "chat.tooltip.subtitle": "Find, value, compare, and inspect cars",
    "chat.header.title": "MilaMark Copilot",
