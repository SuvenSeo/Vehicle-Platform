...
export const DEALER_PLAYBOOK: DealerPlaybookItem[] = [
  {
    ...
    whatAutoLensDoes: "Benchmark listing URLs against live district medians and show the gap in one pass.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Surface district spreads on the map and trend views so you can buy low and place high.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Run import duty and landed-cost scenarios before you wire money or bid on a unit.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Track official DMT and Customs signals in one pulse feed so operators react early.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Estimate fair value from live comps so negotiation starts from a defensible ask.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Watch saved filters and ping when comps land under market.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Package Pro market reports you can walk through in the Monday yard meeting.",
  ...
  },
  {
    ...
    whatAutoLensDoes: "Shortlist strict deal-score picks ready for sourcing and floor planning.",
